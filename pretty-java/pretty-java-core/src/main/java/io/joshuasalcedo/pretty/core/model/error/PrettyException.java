...
/**
 * A beautiful runtime exception implementation that provides colorized stack traces
 * with improved visual formatting and helpful contextual information.
 * Being a RuntimeException, it doesn't force you to catch or declare it.
 */
public class PrettyException extends RuntimeException {
     ...
     */
    public PrettyException(String message, Throwable cause) {
        super(message, cause);
        setupDefaultPackageHighlighting();
    }
     ...
     */
    public PrettyException highlightPackage(String packagePrefix, TerminalStyle style) {
        packageHighlighting.put(packagePrefix, style);
        return this;
    }
    
    /**
     * Creates a wrapped pretty exception from any exception.
     *
     * @param throwable the throwable to wrap
     * @return a PrettyException wrapping the given throwable
     */
    public static PrettyException from(Throwable throwable) {
        if (throwable == null) {
            return null;
        }
        
        if (throwable instanceof PrettyException) {
            return (PrettyException) throwable;
        }
        
        return new PrettyException(throwable.getMessage(), throwable.getCause());
    }
    
    @Override
    public void printStackTrace(PrintStream s) {
        // Use the pretty version
        printPrettyStackTrace(s);
    }
     ...
     */
    public void printPrettyStackTrace(PrintStream out) {
        if (out == null) return;
    ...
    public void printExceptionReport(PrintStream out, Map<String, Object> additionalContext) {
        ...
        printPrettyStackTrace(out);
        
        // Print potential solutions based on exception type
    ...
    /**
     * Builder class for creating PrettyException instances with fluent API.
     */
    public static class Builder {
        private final PrettyException exception;
        
        public Builder() {
            this.exception = new PrettyException();
        }
