...
public class ProgressBarFormat implements VisualFormat {
    ...
    public ProgressBarFormat(
        ...
        this.progress = Math.max(0.0, Math.min(1.0, progress)); // Clamp between 0 and 1
        this.width = width;
        this.color = color;
     ...
     */
    public ProgressBarFormat withColor(PrettyStyle.Color color) {
        return new ProgressBarFormat(
            this.progress,
            this.width,
            color,
    ...
    public String format(String text) {
        ...
        int barWidth = width - 2; // Subtract 2 for the start and end characters
