 ...
 * System.out.println(PrettyStyle.apply(PrettyStyle.TextColor.RED, "This text is red!"));
 *
 * // Combine multiple styles
 * PrettyStyle.Formatter formatter = new PrettyStyle.Formatter()
 *     .withStyle(PrettyStyle.TextStyle.BOLD)
 ...
 * String result = "Warning:".style(PrettyStyle.TextStyle.BOLD)
 *                          .color(PrettyStyle.TextColor.YELLOW)
...
public final class PrettyStyle {
     ...
     */
    @Getter
    public enum TextStyle implements FormatElement {
     ...
     */
    @Getter
    public enum TextColor implements FormatElement {
        // Standard colors
        BLACK(30, "Black text"),
        RED(31, "Red text"),
        GREEN(32, "Green text"),
        ...
        TextColor(int value, String description) {
            this.value = value;
            this.code = CSI + value + "m";
            this.description = description;
        }
        ...
        /**
         * Get a TextColor by its ANSI value
         *
         * @param value The ANSI value
         * @return The matching TextColor or null if not found
         */
        public static TextColor fromValue(int value) {
    ...
    public static class Color256 implements FormatElement {
         ...
         *
         * @param colorCode TextColor code (0-255)
         */
    ...
    public static class Formatter {
         ...
         */
        public Formatter withStyle(TextStyle style) {
            elements.add(style);
            return this;
        }
         ...
         * @return This formatter for method chaining
         */
        public Formatter withColor(TextColor color) {
            elements.add(color);
            return this;
        }
    ...
    public static class StringDecorator {
         ...
         * @return This decorator for method chaining
         */
        public StringDecorator color(TextColor color) {
    ...
    public static String createTable(String[] headers, String[][] rows,
        ...
        for (int rowIndex = 0; rowIndex < rows.length; rowIndex++) {
            ...
            boolean alternate = Math.abs(rowIndex) % 2 == 1;
     ...
     * @return The formatted text
     */
    public static String conditional(String text, boolean condition, TextColor trueColor, TextColor falseColor) {
    ...
    public static String flash(String text, Formatter formatter1, Formatter formatter2) {
        return TextStyle.BLINK.apply(formatter1.apply(text));
    }
