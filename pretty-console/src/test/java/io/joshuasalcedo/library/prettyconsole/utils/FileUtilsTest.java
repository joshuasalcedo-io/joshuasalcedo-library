...
class FileUtilsTest {
    ...
    void testGetFormattedModifiedDate() {
        ...
        SimpleDateFormat format = FileUtils.DATE_FORMAT;
        Date lastModified = new Date(regularFile.lastModified());
        String expected = format.format(lastModified);
    ...
    void testDateFormatConstant() {
        ...
        SimpleDateFormat dateFormat = FileUtils.DATE_FORMAT;
